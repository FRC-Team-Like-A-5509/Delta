...
public class UpTimed extends Command {
	...
	private double fast, speed, secondsPerInches, powerToLift;
    ...
    protected void initialize() {
		fast = SmartDashboard.getNumber("x inches timed fast", 2.4);
    ...
    protected void execute() {
    	Robot.liftDrive.run(powerToLift * Math.signum(m_distanceInInches));
    }
