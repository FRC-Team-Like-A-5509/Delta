...
public class DriveXFeetTimed extends Command {
	...
	private final static double secondsPerFoot = .5/2.51;
	private final static double powerToDrive = .5;
    ...
    protected void execute() {
    	Robot.driveTrain.drive(powerToDrive * Math.signum(m_distanceInFeet));
    }
