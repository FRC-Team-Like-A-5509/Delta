...
public class OI {
	...
	public OI() {
        ...
        SmartDashboard.putData("RunForwardsNoLift", new RunForwardsNoLift());
        SmartDashboard.putData("LeftNotScaleStart", new LeftNotScaleStart());
        SmartDashboard.putData("RightNotScaleStart", new RightNotScaleStart());
